...
namespace SchemeGuiEditor.ToolboxControls
{
    ...
    public enum HorizontalPanelPropNames
    {
        Parent,
        Enabled,
        Border,
    ...
    public class ScmHorizontalPanelProperties :IScmControlProperties
    {
        #region Private Members
        private ScmHorizontalPanel _panel;
        ...
        private List<HorizontalPanelPropNames> _parsedProperties;
        private Dictionary<int, ScmComment> _parsedComments;
        private Dictionary<int, ScmBlock> _parsedScmBlocks;
        #endregion

        public ScmHorizontalPanelProperties(ScmHorizontalPanel panel)
        {
            _panel = panel;
            _enabled = true;
            ...
            _autosizeWidth = true;
            _parsedProperties = new List<HorizontalPanelPropNames>();
        ...
        {
            _parsedProperties.Add(HorizontalPanelPropNames.ScmComment);
            _parsedComments.Add(_parsedProperties.Count - 1, comment);
        }

        public void SetScmBlock(ScmBlock scmBlock)
        {
            _parsedProperties.Add(HorizontalPanelPropNames.ScmBlock);
            _parsedScmBlocks.Add(_parsedProperties.Count - 1, scmBlock);
        }

        public void AddParesedProperty(HorizontalPanelPropNames propertyName)
        {
        ...
        private string GetProppertyCode(HorizontalPanelPropNames propName, int index)
        {
            ...
            switch (propName)
            {
                ...
                case HorizontalPanelPropNames.Alignment:
                    ...
                    _forceDisplay = false;
                    break;
                case HorizontalPanelPropNames.Enabled:
                ...
                case HorizontalPanelPropNames.StrechWidth:
                    ...
                    _forceDisplay = false;
                    break;
                case HorizontalPanelPropNames.StrechHeight:
        ...
        private void AddMissingProperties()
        {
            for (int i = 0; i < 12; i++)    //iterate trough all posible properties
                if (!_parsedProperties.Contains((HorizontalPanelPropNames)i))
                    _parsedProperties.Add((HorizontalPanelPropNames)i);
        }
        #endregion
    }
}
