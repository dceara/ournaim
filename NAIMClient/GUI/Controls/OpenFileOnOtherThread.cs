...
//    public delegate void DialogClosedCallbackDelegate(IOpenDialogEventArgs args);
...
//        protected DialogClosedCallbackDelegate _callbackDelegate;

//        public AOpenDialogOnOtherThread(IOpenFileOnOtherThread parent,DialogClosedCallbackDelegate callbackDelegate) 
//        {
//            this._parent = parent;
...
//    {
//        public OpenFileOnOtherThread(IOpenFileOnOtherThread parent, DialogClosedCallbackDelegate callback)
...
//    {
//        public OpenAddContactDialogOnOtherThread(IOpenFileOnOtherThread parent, DialogClosedCallbackDelegate callback)
//            : base(parent,callback)
//        {
//        }
...
//                return;
//            }
//            this._callbackDelegate(new AddContactDialogEventArgs(addContactDialog.Username, addContactDialog.Group));
...
//    {
//        public OpenAddGroupOnOtherThread(IOpenFileOnOtherThread parent, DialogClosedCallbackDelegate callback)
//            : base(parent,callback)
//        {
//        }
//        public override void Show(object stateInfo)
